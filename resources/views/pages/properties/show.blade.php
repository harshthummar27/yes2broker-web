            ...
            <div>
                ...
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    <a href="{{ config('site.phone_href') }}"
                       class="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-y2b-primary hover:bg-y2b-primary-dark text-white font-bold px-6 py-3 rounded-lg transition text-sm">
